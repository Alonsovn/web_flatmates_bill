...
class ResultsPage(MethodView):
    ...
    def post(self):
        ...
        result = f"{flatmate1.name} pays: {flatmate1.pays(bill, flatmate2)}\n" \
                 f"{flatmate2.name} pays: {flatmate2.pays(bill, flatmate1)}"
        # render the results page, pass name1,amount1,...,variables to page
